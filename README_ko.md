...
- [Windows ZIP 다운로드](https://github.com/Chokyusong/pdf2obsidian/releases/download/v0.1.3/PDF2Obsidian-v0.1.3-windows.zip)
...
- `Local AI (Ollama)`: Ollama가 사용자의 PC에서 이미 실행 중일 때만 쓰는 선택 기능입니다.
...
기본 자막 출력은 고정된 Obsidian 학습 노트 구조를 따릅니다. 핵심 개념, 설명, 예시, 숫자, 비교, 미션, 실행 단계, 복습 포인트를 보존하고 원문에 없는 사실은 만들지 않는 것이 원칙입니다.
